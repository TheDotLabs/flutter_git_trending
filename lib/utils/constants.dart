...
class Constants {
  ...
  static var form_widget_text_style =
      new TextStyle(fontSize: 16, color: Colors.grey[600]);
  static var FORM_WIDGET_TEXTFIELD_PADDING =
      EdgeInsets.only(left: 16, right: 20, top: 14, bottom: 14);
  static var FORM_WIDGET_PADDING_LR =
      const EdgeInsets.only(left: 24, right: 24);
  static var FORM_WIDGET_PADDING_LRTB =
      const EdgeInsets.only(left: 24, right: 24, top: 4, bottom: 8);
  static var FORM_WIDGET_PADDING_LRB =
      const EdgeInsets.only(left: 24, right: 24, bottom: 8);
  static var FORM_WIDGET_PADDING_LRB_DROPDOWN =
      const EdgeInsets.only(left: 16, right: 16, bottom: 8, top: 6);
  ...
  static const String ERROR_SOMETHING_WRONG_500 =
      "Something went wrong! ErrorCode: 500";
